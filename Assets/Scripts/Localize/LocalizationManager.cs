...
namespace Vlandemart.Localization
{
	public class LocalizationManager : MonoBehaviour
	{
		...
		[SerializeField]
		private string AwakeLocalizeLanguageKey;
		...
		private void Awake()
		{
			...
			currentLanguageKey = AwakeLocalizeLanguageKey;
		}

		[ContextMenu("Deserialize")]
		private void DeserializeLocalization()
		{
			DeserializeLocalization(AwakeLocalizeLanguageKey);
		}
		...
		public void DeserializeLocalization(string languageKey)
		{
			...
			Debug.Log("Searching " + languageKey + " in path " + path);
			if (!File.Exists(path))
			{
			...
			{
				Debug.Log(languageKey + " was deserialized!");
			}
